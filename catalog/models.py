...
class Book(models.Model):
    """Model the representing a book (but not a specific copy of a book)."""
...
class BookInstance(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, help_text="Unique ID for the particular book across "
                                                                          "whole library")
